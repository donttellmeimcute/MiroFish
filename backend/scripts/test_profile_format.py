"""
Check whether the generated profile formats satisfy OASIS requirements
Validates:
...
def show_expected_formats():
    """Show the expected OASIS formats."""
    print("\n" + "=" * 60)
