...
/**
 * Check preparation task progress
...
/**
 * Stream the simulation configuration while it is being generated
 * @param {string} simulationId
 * @returns {Promise} Returns configuration data including metadata and the config content
 */
...
/**
 * Get live runtime status for the simulation
 * @param {string} simulationId
 */
...
/**
 * Get detailed runtime status for the simulation, including recent actions
 * @param {string} simulationId
 */
