    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes the uploaded documents and simulation requirements, extracts real-world seeds, and generates a suitable ontology automatically.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the generated ontology, the system chunks the documents, calls Zep to build the knowledge graph, extracts entities and relationships, and produces temporal memories and community summaries.
          </p>
