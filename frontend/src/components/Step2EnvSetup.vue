    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create a simulation instance and load the simulation-world parameter template.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the available context, the system extracts entities and relationships from the knowledge graph, initializes simulated individuals, and gives them unique behavior and memory based on the seed material.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM configures world time flow, recommendation algorithms, activity windows, posting frequency, and event triggers based on the simulation requirement and seed material.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Initial activation events and hot topics are generated from the narrative direction to guide the starting state of the simulation world.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish plans to simulate <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours, with each round representing <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of real-world time</span>
              </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        If the agent count is 100: estimated runtime {{ Math.round(autoGeneratedRounds * 0.6) }} minutes
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">For a first run, strongly consider switching to custom mode to reduce the round count for a faster preview and a lower error risk ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="action-group dual">
            ...
            >
              Start the Dual-World Parallel Simulation ➝
            </button>
          </div>
        </div>
      </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Presented Age</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} years old</span>
            </div>
            <div class="info-item">
              <span class="info-label">Presented Gender</span>
            ...
            <div class="info-item">
              <span class="info-label">Presented MBTI</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">Full Event Journey</span>
                <span class="dim-desc">The complete behavior trajectory within this event</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behavioral Profile</span>
                <span class="dim-desc">Summary of experience and action-style preferences</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Unique Memory Imprint</span>
                <span class="dim-desc">Memories formed from the seed material</span>
              </div>
              <div class="dimension-card">
...
watch(currentStage, (newStage) => {
  if (newStage === '生成Agent人设' || newStage === 'generating_profiles') {
    ...
    // 进入配置生成阶段，开始轮询配置
    if (!configTimer) {
      addLog('Starting dual-platform simulation config...')
      startConfigPolling()
    }
...
const autoGeneratedRounds = computed(() => {
  ...
  // Ensure the maximum round count is at least 40 (recommended) to avoid an invalid slider range
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`Starting simulation with automatically generated rounds: ${autoGeneratedRounds.value} rounds`)
  }
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Detected completed preparation data and will reuse it directly')
      ...
      if (res.data.expected_entities_count) {
        ...
        addLog(`Read from Zep graph: ${res.data.expected_entities_count} entities`)
