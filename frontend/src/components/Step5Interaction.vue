          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A lightweight chat mode for the report-generation agent. It can call four specialized tools and has full access to MiroFish memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with the simulation state and combines global/local memory mechanisms for deep attribution across time and context.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Uses breadth-first traversal on the graph structure to reconstruct propagation paths and capture full information-flow topology.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">An instant GraphRAG query interface optimized for indexing efficiency and fast retrieval of node properties and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Runs autonomous interviews with simulated individuals in parallel to collect unstructured opinions and psychological state data.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Type the question you want to ask every selected target..."
                rows="3"
              ></textarea>
            </div>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Choose a conversation target: ${agent.username}`)
}
