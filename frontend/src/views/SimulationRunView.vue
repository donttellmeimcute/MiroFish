  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      try {
        ...
        addLog('Failed to close the simulation environment. Attempting force stop...')
        try {
  ...
  try {
    ...
    if (simRes.success && simRes.data) {
      ...
      try {
        ...
        addLog(`Failed to load time configuration, using default: ${minutesPerRound.value} minutes/round`)
      }
